...
internal static class DataSource
{
    ...
    {   
        ...
        internal static int NextTaskId { get => nextTaskId++; set => nextTaskId = 1; } ///will update the value
        ...
        internal static int NextDependencyId { get => nextDependencyId++; set => nextDependencyId = 1; }///will update the value
